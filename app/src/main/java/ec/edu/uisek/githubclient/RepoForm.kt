...
// Actividad para crear o editar un repositorio. parcial 1
class RepoForm : AppCompatActivity() {
    private lateinit var binding: ActivityRepoFormBinding
    private var repoOwner: String? = null          // Propietario del repositorio (para editar). parcial 1
    private var originalRepoName: String? = null // Nombre original del repo (para editar). parcial 1
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Recibe los datos si se está editando un repositorio. parcial 1
        repoOwner = intent.getStringExtra("REPO_OWNER")
        originalRepoName = intent.getStringExtra("REPO_NAME")

        // Si hay un nombre de repo original, es una edición. Rellena los campos. parcial 1
        ...
        // Listener para el botón de guardar. parcial 1
        binding.saveRepoButton.setOnClickListener {
            ...
            if (repoName.isNotEmpty()) {
                ...
                // Si existe un nombre de repo original, actualiza. Si no, crea. parcial 1
                if (repoOwner != null && originalRepoName != null) {
    ...
    // Llama a la API para crear un nuevo repositorio. parcial 1
        ...
        call.enqueue(object : Callback<Repo> {
            override fun onResponse(call: Call<Repo>, response: Response<Repo>) {
                if (response.isSuccessful) {
                    ...
                    finish() // Cierra la actividad. parcial 1
                } else {
    ...
    // Llama a la API para actualizar un repositorio existente. parcial 1
